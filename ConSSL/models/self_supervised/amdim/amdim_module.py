...
from ConSSL.losses.self_supervised_learning import FeatureMapContrastiveTask
from ConSSL.models.self_supervised.amdim.datasets import AMDIMPretraining
from ConSSL.models.self_supervised.amdim.networks import AMDIMEncoder
...
class AMDIM(pl.LightningModule):
    ...
    Example:
        ...
        >>> from ConSSL.models.self_supervised import AMDIM
        ...
