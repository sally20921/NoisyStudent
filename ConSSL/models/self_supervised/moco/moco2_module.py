...
from ConSSL.metrics import mean, precision_at_k
from ConSSL.models.self_supervised.moco.transforms import (
...
def cli_main():
    from ConSSL.datamodules import CIFAR10DataModule, SSLImagenetDataModule, STL10DataModule
