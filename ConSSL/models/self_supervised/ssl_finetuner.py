...
from ConSSL.models.self_supervised import SSLEvaluator
...
class SSLFineTuner(pl.LightningModule):
    ...
    Example::
        ...
        from ConSSL.utils.self_supervised import SSLFineTuner
        from ConSSL.models.self_supervised import CPCV2
        from ConSSL.datamodules import CIFAR10DataModule
        from ConSSL.models.self_supervised.cpc.transforms import CPCEvalTransformsCIFAR10,
